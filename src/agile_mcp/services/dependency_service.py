...
class DependencyService:
    ...
    def add_story_dependency(self, story_id: str, depends_on_story_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not self.dependency_repository.story_exists(depends_on_story_id):
                raise StoryNotFoundError(f"Story with ID '{depends_on_story_id}' not found")
            
            # Check for circular dependency
            if self.dependency_repository.has_circular_dependency(story_id, depends_on_story_id):
                raise CircularDependencyError(
                    f"Adding dependency from '{story_id}' to '{depends_on_story_id}' would create a circular dependency"
                )
            
            # Add the dependency
            result = self.dependency_repository.add_dependency(story_id, depends_on_story_id)
        ...
        except (DependencyValidationError, CircularDependencyError, DuplicateDependencyError, StoryNotFoundError):
    ...
    def get_story_dependencies(self, story_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise DatabaseError(f"Database operation failed while retrieving dependencies: {str(e)}")
    ...
    def get_story_dependents(self, story_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise DatabaseError(f"Database operation failed while retrieving dependents: {str(e)}")
    
    def remove_story_dependency(self, story_id: str, depends_on_story_id: str) -> Dict[str, Any]:
        """
        ...
        try:
            result = self.dependency_repository.remove_dependency(story_id, depends_on_story_id)
    ...
    def validate_dependency_graph(self, story_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise DatabaseError(f"Database operation failed during validation: {str(e)}")