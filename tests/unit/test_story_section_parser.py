...
class TestStoryParser:
    ...
    def test_extract_section_success(self, story_parser, sample_story_content):
        ...
        result = story_parser.extract_section(sample_story_content, "Acceptance Criteria")
    ...
    def test_extract_section_empty_section_name(self, story_parser, sample_story_content):
    ...
    def test_extract_section_whitespace_section_name(self, story_parser, sample_story_content):
...
'''
    ...
    def test_normalize_section_name_valid(self, story_parser):
        ...
        assert story_parser.normalize_section_name("  Status  ") == "Status"
        assert story_parser.normalize_section_name("acceptance criteria") == "Acceptance Criteria"
    ...
    def test_list_sections(self, story_parser, sample_story_content):
        ...
        expected_sections = ["Status", "Story", "Acceptance Criteria", "Tasks / Subtasks", "Dev Notes", "Testing"]
...
- [ ] Task 2"""
    ...
    def test_find_sections_internal_method(self, story_parser, sample_story_content):
        ...
        expected_names = ["Status", "Story", "Acceptance Criteria", "Tasks / Subtasks", "Dev Notes", "Testing"]
