...
def test_isolated_memory_db_fixture(isolated_memory_db):
    ...
    try:
        # Add test data
        epic = Epic(id="fixture_test", title="Fixture Test", description="Test", status="Ready")
        session.add(epic)
        session.commit()
...
def test_test_session_fixture(test_session):
    ...
    # Add test data
    epic = Epic(id="session_test", title="Session Test", description="Test", status="Ready")
...
def test_integration_session_fixture(integration_session):
    ...
    # Add test data
    epic = Epic(id=test_id, title="Integration Test", description="Test", status="Ready")
...
def test_isolated_file_db_fixture(isolated_file_db):
    ...
    try:
        # Add test data
        epic = Epic(id="file_test", title="File Test", description="Test", status="Ready")
        session.add(epic)
        session.commit()
