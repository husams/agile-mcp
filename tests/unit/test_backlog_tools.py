...
class TestGetNextReadyStoryTool:
    ...
    def test_get_next_ready_story_success_with_story(self, mock_get_db, mock_create_tables):
        ...
        with patch('src.agile_mcp.api.backlog_tools.StoryRepository') as mock_story_repo_class, \
             patch('src.agile_mcp.api.backlog_tools.DependencyRepository') as mock_dep_repo_class, \
             patch('src.agile_mcp.api.backlog_tools.StoryService') as mock_story_service_class:
    ...
    @patch('src.agile_mcp.api.backlog_tools.create_tables')
    @patch('src.agile_mcp.api.backlog_tools.get_db')
    def test_get_next_ready_story_no_stories_available(self, mock_get_db, mock_create_tables):
        """Test getNextReadyStory when no stories are ready."""
        # Setup mocks
        mock_db_session = Mock()
        mock_get_db.return_value = mock_db_session
        
        with patch('src.agile_mcp.api.backlog_tools.StoryRepository'), \
             patch('src.agile_mcp.api.backlog_tools.DependencyRepository'), \
             patch('src.agile_mcp.api.backlog_tools.StoryService') as mock_story_service_class:
    ...
    def test_get_next_ready_story_database_error(self, mock_get_db, mock_create_tables):
        ...
        with patch('src.agile_mcp.api.backlog_tools.StoryRepository'), \
            ...
            mock_story_service = Mock()
            mock_story_service.get_next_ready_story.side_effect = DatabaseError("Database connection failed")
            mock_story_service_class.return_value = mock_story_service
    ...
    @patch('src.agile_mcp.api.backlog_tools.create_tables')
    @patch('src.agile_mcp.api.backlog_tools.get_db')
    def test_get_next_ready_story_validation_error(self, mock_get_db, mock_create_tables):
        ...
        with patch('src.agile_mcp.api.backlog_tools.StoryRepository'), \
            ...
            mock_story_service = Mock()
            mock_story_service.get_next_ready_story.side_effect = StoryValidationError("Dependency repository required")
            mock_story_service_class.return_value = mock_story_service
