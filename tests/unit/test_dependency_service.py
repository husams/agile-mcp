...
def test_add_story_dependency_success(dependency_service, mock_dependency_repository):
    ...
    mock_dependency_repository.has_circular_dependency.assert_called_once_with("story-1", "story-2")
...
def test_add_story_dependency_story_not_found(dependency_service, mock_dependency_repository):
    """Test story not found error."""
    # Setup first story doesn't exist
    mock_dependency_repository.story_exists.side_effect = lambda story_id: story_id != "story-1"
...
def test_add_story_dependency_depends_on_story_not_found(dependency_service, mock_dependency_repository):
    """Test dependency story not found error."""
    # Setup second story doesn't exist
    mock_dependency_repository.story_exists.side_effect = lambda story_id: story_id != "story-2"
...
def test_add_story_dependency_self_dependency(dependency_service, mock_dependency_repository):
...
def test_add_story_dependency_duplicate_dependency(dependency_service, mock_dependency_repository):
    """Test duplicate dependency handling."""
    # Setup mocks
    mock_dependency_repository.story_exists.side_effect = lambda story_id: True
    mock_dependency_repository.has_circular_dependency.return_value = False
    mock_dependency_repository.add_dependency.return_value = False  # Dependency already exists
...
def test_add_story_dependency_empty_story_id(dependency_service, mock_dependency_repository):
...
def test_add_story_dependency_empty_depends_on_story_id(dependency_service, mock_dependency_repository):
...
def test_add_story_dependency_whitespace_story_ids(dependency_service, mock_dependency_repository):
...
def test_add_story_dependency_database_error(dependency_service, mock_dependency_repository):
    """Test database error handling."""
    # Setup database error
    mock_dependency_repository.story_exists.side_effect = SQLAlchemyError("Database connection failed")
...
def test_get_story_dependencies_success(dependency_service, mock_dependency_repository):
    ...
    mock_dependency_repository.get_story_dependencies.return_value = [mock_story_1, mock_story_2]
...
def test_get_story_dependencies_empty_list(dependency_service, mock_dependency_repository):
...
def test_get_story_dependencies_story_not_found(dependency_service, mock_dependency_repository):
...
def test_remove_story_dependency_success(dependency_service, mock_dependency_repository):
    ...
    mock_dependency_repository.remove_dependency.assert_called_once_with("story-1", "story-2")


def test_remove_story_dependency_not_found(dependency_service, mock_dependency_repository):
...
def test_validate_dependency_graph_success(dependency_service, mock_dependency_repository):
...
def test_validate_dependency_graph_with_circular_dependency(dependency_service, mock_dependency_repository):
