    ...
    story_response = send_jsonrpc_request(
        ...
        "tools/call",
        {
            ...
            "arguments": {
                ...
                "acceptance_criteria": ["Should link artifacts", "Should retrieve artifacts"]
            }
        }
    )
...
class TestArtifactToolsE2E:
    ...
    def test_complete_workflow_create_story_link_artifacts_retrieve(self, mcp_server_process):
        ...
        story_response = send_jsonrpc_request(
            ...
            "tools/call",
            {
                ...
                "arguments": {
                    ...
                    "acceptance_criteria": ["Should create epic", "Should create story", "Should link artifacts", "Should retrieve artifacts"]
                }
            }
        )
        story_data = json.loads(story_response["result"]["content"][0]["text"])
